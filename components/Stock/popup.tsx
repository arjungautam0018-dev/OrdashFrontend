...
const styles = StyleSheet.create({
    ...
    sheet: {
        ...
        paddingHorizontal: s(20), paddingBottom: s(36), paddingTop: s(12),
    },
    handle: {
        width: s(40), height: s(4), borderRadius: s(2),
        backgroundColor: "#E5E7EB", alignSelf: "center", marginBottom: s(16),
    },
    sheetTitle: { fontSize: sf(17), fontWeight: "700", color: "#1E3A8A", marginBottom: s(16) },
    label: { fontSize: sf(13), fontWeight: "600", color: "#6B7280", marginBottom: s(4) },
    input: {
        height: s(44), backgroundColor: "#F9FAFB",
        borderRadius: s(8), borderWidth: 1, borderColor: "#E5E7EB",
        paddingHorizontal: s(12), fontSize: sf(15), color: "#111827", marginBottom: s(12),
    },
    sheetActions: { flexDirection: "row", gap: s(12), marginTop: s(4) },
    deleteBtn: {
        flex: 1, paddingVertical: s(13), borderRadius: s(10),
        borderWidth: 1.5, borderColor: "#FECACA", backgroundColor: "#FEF2F2",
        alignItems: "center",
    },
    deleteBtnText: { fontSize: sf(15), fontWeight: "600", color: "#DC2626" },
    saveBtn: {
        flex: 2, paddingVertical: s(13), borderRadius: s(10),
        backgroundColor: "#F7D060", alignItems: "center",
    },
    saveBtnText: { fontSize: sf(15), fontWeight: "700", color: "#1a1a1a" },
});
