...
// Logout Icon 
// 👤 Account Icon
export const AccountIcon = ({ size = 30, color = "#000000" }: { size?: number; color?: string }) => (
...
// 🗑️ Delete Icon
export const DeleteIcon = ({ size = 24, color = "#e04242" }: { size?: number; color?: string }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
...
// ✏️ Edit / Pencil Icon
export const EditIcon = ({ size = 24, color = "#4a42e0" }: { size?: number; color?: string }) => (
  <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    <Path
      d="M15.232 5.232l3.536 3.536M4 20h3.536L18.5 9.036a2.5 2.5 0 0 0-3.536-3.536L4 16.464V20Z"
      stroke={color}
      strokeWidth={1.6}
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const LogoutIcon = ({ size = 24, color = "#FFFFFF" }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
