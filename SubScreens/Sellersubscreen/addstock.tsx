...
const styles = StyleSheet.create({
    ...
    dropdownValue: { fontSize: 15, fontWeight: "500", color: "#111827" },
    ...
    currencyText: { fontSize: 18, fontWeight: "700", color: "#1E3A8A" },
    priceInput: {
        flex: 1,
        height: 44,
        backgroundColor: "#F9FAFB",
    ...
    minusBtnText: { fontSize: 24, fontWeight: "400", color: "#374151", lineHeight: 28 },
    countBox: { flex: 1, alignItems: "center", justifyContent: "center" },
    countNumber: { fontSize: 32, fontWeight: "700", color: "#1E3A8A", lineHeight: 36 },
    countInput: {
        fontSize: 32,
        fontWeight: "700",
        color: "#1E3A8A",
    ...
    countLabel: { fontSize: 12, color: "#9CA3AF", marginTop: 2 },
    plusBtn: {
        width: 52, height: 52, borderRadius: 12,
    ...
    plusBtnText: { fontSize: 24, fontWeight: "600", color: "#1a1a1a", lineHeight: 28 },
    ...
    addBtnText: { fontSize: 15, fontWeight: "700", color: "#1a1a1a" },
    ...
    modalTitle: {
        fontSize: 16, fontWeight: "700", color: "#1E3A8A", marginBottom: 12,
    },
    catItem: {
        flexDirection: "row", alignItems: "center", justifyContent: "space-between",
        paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: "#F3F4F6",
    },
    catItemText: { fontSize: 15, fontWeight: "500", color: "#374151" },
